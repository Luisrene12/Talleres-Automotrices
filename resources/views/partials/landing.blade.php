                ...
                <div class="row align-items-center min-vh-75">
                    <div class="col-lg-6 landing-hero-content reveal">
                        ...
                        <div class="landing-hero-actions mt-4 d-flex align-items-center gap-3">
                            ...
                            <button class="btn btn-outline-light border-0 px-4 py-3" style="font-weight: 600; font-family: var(--font-body);">
                                <i class="fa-solid fa-play me-2"></i> Ver reel
                            </button>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div id="landingLocations" class="landing-locations">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="glass-card-3d tilt-element reveal" style="overflow:hidden; padding:0; border-radius:24px;">
                            <div id="tallerMapa" style="width:100%; height:420px;"></div>
